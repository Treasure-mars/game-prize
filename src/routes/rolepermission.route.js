...
router.get("/role/:id", verifyToken, checkRole('VIEW_ROLES'), Role.getRole)
router.patch("/role/:id", verifyToken, checkRole('ADD_ROLE'), Role.updateRole)
router.delete("/role/:id", verifyToken, checkRole('ADD_ROLE'), Role.deleteRole)
...
router.get("/permission/:id", verifyToken, checkRole('VIEW_ROLES'), Permission.getPermission)
router.patch("/permission/:id", verifyToken, checkRole('ADD_ROLE'), Permission.updatePermission)
router.delete("/permission/:id", verifyToken, checkRole('ADD_ROLE'), Permission.deletePermission)
...
router.get("/roles/:roleId/permissions/:permissionId", verifyToken, checkRole('VIEW_ROLES'), RolePermission.getRolePermissions)
