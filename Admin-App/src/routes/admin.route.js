...
router.get("/banned", verifyToken, checkRole('VIEW_USERS'), Admin.getAllBannedUsers)
router.get("/all", verifyToken, checkRole('VIEW_USERS'), Admin.getAllUsers)
router.get("/:userId", verifyToken, checkRole('VIEW_USERS'), Admin.getUserById)
...
router.delete("/banned/:userId", verifyToken, checkRole('ADD_USER'), Admin.unbanUser)
